...
using Nop.Plugin.Misc.WebApiServices.Extensions;
...
namespace Nop.Plugin.Misc.WebApiServices.Controllers
{
    public class ProductController : BaseApiController
    {
          ...
          bool forceRedirectionAfterAddingToCart = false)
        {
         ...
         public static IList<ProductSpecificationModel> PrepareProductSpecificationModel(
            IWorkContext workContext,
            ISpecificationAttributeService specificationAttributeService,
            ICacheManager cacheManager,
            Product product)
             ...
             ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false)
         {
             ...
             {
                 model.AddToCart.AllowedQuantities.Add(new System.Web.Mvc.SelectListItem()
                 {
                     Text = qty.ToString(),
                     Value = qty.ToString(),
             ...
             if (!isAssociatedProduct)
             {
                 model.ProductSpecifications = PrepareProductSpecificationModel(_workContext,
        ...
        [ActionName("homepage")]
        [HttpGet]
        public IHttpActionResult HomepageProducts([FromUri]int id)
        {
            int productThumbPictureSize = id;
